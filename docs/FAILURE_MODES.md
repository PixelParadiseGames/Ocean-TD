...
| Skills PowerUpTemplate sucked into bubble sim | Collected every ImageButton under MobileSkillsA | Only `PlotSizeBTN` / `EarnMoreBTN` / `PlaceMoreBTN` become bubbles (`SkillStages`); stage layout BTNs (`RHealthBTN`…) stay templates |
