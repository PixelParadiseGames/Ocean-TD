...
local function makeHungerBillboard(adornee: BasePart): (BillboardGui, Frame, Frame, TextLabel, TextLabel, UIScale, UIStroke?)
...
local function setFishCFrame(agent: GhostFish, world: Vector3, pathTang: Vector3, dt: number)
	...
	local desired = CFrame.lookAt(world, world + move, Vector3.yAxis)
